...
# ── GitHub API للحفظ الدائم ──
GITHUB_TOKEN  = st.secrets.get("github_token", "")
GITHUB_REPO   = st.secrets.get("github_repo", "husseinali77121-cell/orange-home-visit")
GITHUB_BRANCH = st.secrets.get("github_branch", "main")
GITHUB_JSON_PATH  = "Visits.json"
...
if "github_loaded" not in st.session_state:
    ...
    if count_check == 0 and GITHUB_TOKEN:
