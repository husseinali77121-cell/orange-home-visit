...
if _egg_hi:
    st.markdown(
        f'<div style="background:linear-gradient(90deg,#FF6B00,#FF9A3D);color:#fff;'
        f'border-radius:12px;padding:10px 16px;margin:8px 0;font-size:14px;'
        f'font-weight:700;direction:rtl;text-align:center;">{_egg_hi}</div>',
        unsafe_allow_html=True)
