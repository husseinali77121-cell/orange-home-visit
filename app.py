...
# ── تحذير حالة التخزين السحابي (GitHub) ──
_gh_check_connection()

# ══════════════════════════════════════════════════════════════════════════════
# ★ التحويل الآلي للحالة — زيارة عدّى ميعادها تبقى «تمت» لوحدها
# ══════════════════════════════════════════════════════════════════════════════
# شرط الأمان: مايشتغلش غير لو مزامنة الإقلاع من GitHub نجحت (أو GitHub مش متظبط أصلًا
# يعني تشغيل محلي)، عشان مايكتبش نسخة ناقصة فوق النسخة الكاملة.
