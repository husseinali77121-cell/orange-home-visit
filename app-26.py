...
def export_to_excel(branch_filter=None, month=None, year=None, date_from=None, date_to=None):
    ...
    # يسار: Developer credit
    ws.merge_cells(start_row=SIG_ROW, start_column=1, end_row=SIG_ROW+1, end_column=3)
    ...
    # يمين: Lab Manager Signature
    ws.merge_cells(start_row=SIG_ROW, start_column=5, end_row=SIG_ROW, end_column=7)
    c = ws.cell(SIG_ROW, 5, "Lab Manager Signature")
    c.font = Font(name="Cairo", bold=True, size=10, color="222222")
    c.alignment = Alignment(horizontal="center", vertical="bottom")
    c.border = Border(bottom=Side(style="medium", color="222222"))
    ws.merge_cells(start_row=SIG_ROW+1, start_column=5, end_row=SIG_ROW+1, end_column=7)
    c = ws.cell(SIG_ROW+1, 5, "Dr. Hussein Ali")
    c.font = Font(name="Cairo", size=9, color="888888")
            ...
            if summary:
                ...
                printable_html = f"""<div id="printable-report" style="direction:rtl;font-family:'Cairo',sans-serif;padding:20px;background:white;color:black;">
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:flex-end;margin-top:40px;">
                        ...
                        <div style="text-align:center;width:40%;">
                            <div style="border-bottom:1px solid #333;min-height:50px;margin-bottom:4px;"></div>
                            <p style="margin:0;font-size:12px;color:#333;font-weight:700;">Lab Manager Signature</p>
                            <p style="margin:2px 0 0;font-size:11px;color:#888;">Dr. Hussein Ali</p>
                        </div>
                    </div>
